...
def show_contact_page():
    # If this grows too large, consider moving the <style> block to a separate styles.css file
    st.markdown("""
    <style>
    /* Import Google Fonts */
    ...
    * {
    ...
    /* —— NEW: Prevent long links/emails from overflowing —— */
    .contact-info a {
    ...
    .contact-info a { text-decoration: none; transition: all 0.3s ease; }
    ...
    with col1:
        st.markdown('<div style="text-align:center;"><a href="mailto:riaskingofanime@gmail.com?subject=General Inquiry" class="contact-button">💬 General Support</a></div>', unsafe_allow_html=True)
    with col2:
        st.markdown('<div style="text-align:center;"><a href="mailto:riaskingofanime@gmail.com?subject=Technical Issue" class="contact-button">🔧 Technical Help</a></div>', unsafe_allow_html=True)
    with col3:
        st.markdown('<div style="text-align:center;"><a href="mailto:riaskingofanime@gmail.com?subject=Feedback" class="contact-button">⭐ Send Feedback</a></div>', unsafe_allow_html=True)
